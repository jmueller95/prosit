...
for is_trained in [True, False]:
	...
	#Load both at once and concatenate
	...
	iRT_weights_filename = "{}/weight_{:02d}_{:.5f}{}.hdf5".format(iRT_model_dir, iRT_epochs, iRT_val_loss, "_transfer_trained" if is_trained else "")
